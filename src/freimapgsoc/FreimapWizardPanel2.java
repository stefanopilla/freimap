...
public class FreimapWizardPanel2 implements WizardDescriptor.ValidatingPanel {

    /**
     * The visual component that displays this panel. If you need to access the
     * component from this class, just use getComponent().
     */
    private FreimapVisualPanel2 component;
    ...
    public Component getComponent() {
        if (component == null) {
            component = new FreimapVisualPanel2();
        }
        return component;
    }
    ...
    public void validate() throws WizardValidationException {
        ...
        String database = component.getDatabase();
        ...
        if (port.equals("")) {
            port = "3306";
            throw new WizardValidationException(null, "Will be used the default port: 3306", null);
        }
        if (username.equals("")) {
            isValid = false;
            throw new WizardValidationException(null, "Invalid Username", null);
        }
        if (database.equals("information_schema")) {
            isValid = false;
            throw new WizardValidationException(null, "You cannot use selected Database", null);
        }
        if (database.equals("")) {
            isValid = false;
